...
*/
        ...
        var options = {
            headers: {'Api-Key': 'v8tkykxqmu4ghnp5unakmdyv'}, // il faut mettre une clé entre les ''
            url: 'https://api.gettyimages.com/v3/search/images?phrase=flower',
            dataType: 'json',
            type: 'GET',
        };
        ...
        request.get(options).then(function(body)
        {
            ...
            // Boucle pour afficher tous les élements du tableau
        })
